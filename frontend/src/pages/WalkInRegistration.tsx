...
const WalkInRegistration: React.FC = () => {
  ...
  if (success) {
    return (
      <SubmissionStatus
        ...
        message={
          <>
            <p>Your registration is complete. You may now enter the event. Have a great day!</p>
  ...
  return (
    <div className="glass-card p-6 md:p-8 transition-all duration-500">
      <div className="mb-6">
        <h2 className="text-xl md:text-2xl font-bold text-white tracking-tight">Student Walk-In</h2>
        <p className="text-app-text-secondary text-[10px] md:text-xs mt-1 uppercase tracking-widest font-medium">On-site Registration & Check-in</p>
      </div>
